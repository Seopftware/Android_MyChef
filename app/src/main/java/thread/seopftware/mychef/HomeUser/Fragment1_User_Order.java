...
public class Fragment1_User_Order extends Fragment {
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                ...
                return new OrderList_viewpager();
            } else if (position == 1) {
                return new OrderList_viewpager2();
            } else {
                return new OrderList_viewpager3();
            }
        }
